              ...
              >
                <div className="p-8 md:p-12 min-h-full flex flex-col">
                  ...
                  <div className="flex justify-between items-start mb-12 border-b border-gray-800 pb-6">
                    <div>
                      <h2 className="text-6xl md:text-8xl font-black uppercase tracking-tighter text-white leading-[0.8] md:leading-none break-words">THIS IS<br className="md:hidden" />MUSIC</h2>
                    </div>
